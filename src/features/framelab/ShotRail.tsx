...
import { slugLine } from "./frameLogic";
...
/**
 * Left rail: every shot in the project grouped under its scene's slug line.
 * Picking a row drives the stage, console, and history surfaces.
 */
export const ShotRail = ({
  ...
  <nav
    aria-label={frameLabCopy.rail.label}
      ...
      <span className="flex min-w-0 flex-col gap-0.5">
        ...
        >
          {description.length > 0
            ? description
            : frameLabCopy.rail.noDescription}
        </span>
